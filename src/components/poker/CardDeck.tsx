...
export function CardDeck({
  ...
  return (
    <div className="w-full bg-retro-blue border-t-4 border-black p-1.5 sm:p-3 brutal-shadow">
      <div className="w-full mx-auto">
        <h3 className="text-center text-[7px] sm:text-[8px] font-black uppercase tracking-[0.2em] mb-1 sm:mb-2">
